...
function addToCart(name, price){
   ...
   updateCartModal();
    ...
    function updateCartModal(){
        ...
        cart.forEach(item => {
            ...
            cartITemsElement.innerHTML =`
                <div class="flex intems-center justify-between">
                 <div>
                    <p calss= "font-medium">${item.name}</p>
        ...
        //Calcula o valor total da conta no modal 
        ...
        //Adiciona a quantidade de intens ao lado do "Veja meu carrinho"
